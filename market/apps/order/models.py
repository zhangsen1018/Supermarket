...
class Order(Base_model):
    ...
    user = models.ForeignKey(to="user.Users", verbose_name="用户")
...
class OrderGoods(Base_model):
    """订单商品详情表"""
    order = models.ForeignKey(to="Order", verbose_name="订单ID")
    goods_sku = models.ForeignKey(to="goods.GoodsSKU", verbose_name="订单商品ID")
